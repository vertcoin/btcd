...
var VertcoinGenesisHash = chainhash.Hash([chainhash.HashSize]byte{ // Make go vet happy.
...
var VertcoinMerkleRoot = chainhash.Hash([chainhash.HashSize]byte{ // Make go vet happy.
...
// VertcoinTestnetGenesisBlock has is like completely its own thing
